...
It is possible to run DarkSilk as a Tor hidden service, and connect to such services.
...
1. Run darksilk behind a Tor proxy
----------------------------------

The first step is running DarkSilk behind a Tor proxy. This will already make all
...
port 9050 and only allows .onion nodes to connect:
	...
	./darksilkd -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=ssapp53tmftyjmjb.onion

In a typical situation, this suffices to run behind a Tor proxy:

	./darksilkd -proxy=127.0.0.1:9050


2. Run a darksilk hidden server
-------------------------------
...
your darksilkd's P2P listen port (31600 by default).
	...
	-externalip=X   You can tell darksilk about its publicly reachable address using
	                ...
	                /var/lib/tor/darksilk-service/hostname. Onion addresses are given
...
In a typical situation, where you're only reachable via Tor, this should suffice:
	...
	./darksilkd -proxy=127.0.0.1:9050 -externalip=ssapp53tmftyjmjb.onion -listen
