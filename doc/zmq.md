...
The ZeroMQ feature in DarkSilk Core requires ZeroMQ API version 4.x or
...
For instance:
    ...
    $ darksilkd -zmqpubhashtx=tcp://127.0.0.1:28332 \
               -zmqpubrawtx=ipc:///tmp/darksilkd.tx.raw
...
using. darksilkd appends an up-counting sequence number to each
