...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_DYNAMIC_ASSET DYNQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_DYNAMIC_ASSET DYNO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_DYNAMIC_ASSET DYNR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_DYNAMIC_ASSET DYNT
