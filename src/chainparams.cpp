...
public:
    CMainParams() {
        ...
        consensus.nSuperblockCycle = 20545; // 675 (Blocks per day) x 365.25 (Days per Year) / 12 = 20545 (Blocks per Month)
        ...
        vAlertPubKey = ParseHex(""); //TODO (Amir): Change alert public key
        ...
        if(!startNewChain) {
            assert(consensus.hashGenesisBlock == uint256S("0x0000066c6ee5b14a9e9cbe06226618a57589add016fe770d283e5b7eea1e57d0"));
        ...
        strSporkPubKey = ""; //TODO (Amir): Change spork public key
...
public:
    CTestNetParams() {
        ...
        consensus.nDynodePaymentsStartBlock = 0; // Dynode payments starts on block 0
