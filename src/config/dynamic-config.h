/* src/config/dynamic-config.h.  Generated from dynamic-config.h.in by configure.  */
/* src/config/dynamic-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_STRING "Dynamic 1.0.0"
