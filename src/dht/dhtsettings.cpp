...
void CDHTSettings::LoadSettings()
{
	...
	// ``enable_dht`` starts the dht node and makes the trackerless service available to
	// torrents.
	...
	settings.set_str(settings_pack::user_agent, "Dynamic"); //todo: add version to user agent
