...
static const int MIN_GOVERNANCE_PEER_PROTO_VERSION = 70600;
static const int GOVERNANCE_FILTER_PROTO_VERSION = 70700;
...
static const CAmount GOVERNANCE_PROPOSAL_FEE_TX = (20.0*COIN);
