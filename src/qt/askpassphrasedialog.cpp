...
AskPassphraseDialog::AskPassphraseDialog(Mode _mode, QWidget* parent, WalletModel* model, Context context) : QDialog(parent),
...
void AskPassphraseDialog::textChanged()
{
    ...
    case Mode::Encrypt: // New passphrase x2
        ...
        break;
    case Mode::UnlockMixing: // Old passphrase x1
