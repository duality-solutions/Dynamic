    ...
    BOOST_FOREACH(CNode* pnode, vNodesCopy)    {
        ...
        // NORMAL NETWORK MODE - TESTNET/MAINNET
        {
            ...
            if(pCurrentBlockIndex->nHeight - 1 > stats.nCommonHeight) {
                ...
                pnode->fDisconnect = true;
                LogPrintf("CStormnodeSync::ProcessTick -- disconnecting from stuck peer, nHeight=%d, nCommonHeight=%d, peer=%d\n",
                ...
                LogPrintf("CStormnodeSync::ProcessTick -- skipping peer, who announced more headers than we have blocks currently, nHeight=%d, nSyncHeight=%d, peer=%d\n",
