...
BOOST_FIXTURE_TEST_SUITE(asset_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(name_validation_tests)
    {
        ...
        //- Versions of DYNAMIC NOT allowed
        BOOST_CHECK(!IsAssetNameValid("DYN", type));
        BOOST_CHECK(!IsAssetNameValid("DYNAMIC", type));

        //- Versions of DYNAMIC ALLOWED
        BOOST_CHECK(IsAssetNameValid("DYNAMIC_COIN", type));
