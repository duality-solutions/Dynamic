...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler DYN tx
        CScript dynTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut dynOut(1*COIN, dynTransfer);
        ...
        mutTxTest1.vout.emplace_back(dynOut);
        ...
        mutTxTest2.vout.emplace_back(dynOut);
        ...
        mutTxTest3.vout.emplace_back(dynOut);
        ...
        mutTxTest4.vout.emplace_back(dynOut);
        ...
        mutTxTest5.vout.emplace_back(dynOut);
        ...
        mutTxTest6.vout.emplace_back(dynOut);
        ...
        mutTxTest7.vout.emplace_back(dynOut);
        ...
        mutTxTest8.vout.emplace_back(dynOut);
