...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CDarkSilkAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CDarkSilkAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CDarkSilkAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CDarkSilkAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CDarkSilkAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CDarkSilkAddress(arr[0].get_str()).Get() == demoAddress.Get());
