...
#ifndef DYNAMIC_WALLET_FEEBUMPER_H
#define DYNAMIC_WALLET_FEEBUMPER_H
...
{
public:
    CFeeBumper(const CWallet *pWalletIn, const uint256 txidIn, const CCoinControl& coinControl, CAmount totalFee);
...
#endif // DYNAMIC_WALLET_FEEBUMPER_H
